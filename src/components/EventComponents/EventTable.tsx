...
import { FaDollarSign, FaCalendarAlt, FaBuilding, FaEdit, FaTrash, FaCheck } from 'react-icons/fa'; 
        ...
        <TableHeader>
          <TableRow>
            ...
            <TableHead className="w-1/6 py-4 text-gray text-lg">
              Venue <FaBuilding className="inline ml-2" />
            </TableHead>
            <TableHead className="w-1/6 py-4 text-gray text-lg">
              Cost <FaDollarSign className="inline ml-2" />
            </TableHead>
            <TableHead className="w-1/6 py-4 text-gray text-lg">
              Start <FaCalendarAlt className="inline ml-2" />
            </TableHead>
            <TableHead className="w-1/6 py-4 text-gray text-lg">
              Status
            </TableHead>
              ...
              <TableRow key={event.id}>
                ...
                <TableCell className="py-8 text-m">
                  {event.status === 'completed' ? (
                    <>
                      {event.status} <FaCheck className="inline ml-2 text-green-500" />
                    </>
                  ) : (
                    event.status
                  )}
