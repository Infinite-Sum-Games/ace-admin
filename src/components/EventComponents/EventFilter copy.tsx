...
import { FaFilter, FaSearch, FaCalendarAlt, FaTag } from 'react-icons/fa';
          ...
          <div className="space-y-2">
            ...
            <label className="flex items-center">
              <input
                ...
                className="mr-2"
              />
              <FaTag className="mr-2" /> Cost: Free
            </label>
            <label className="flex items-center">
              <input
                type="checkbox"
                ...
                className="mr-2"
              />
              <FaTag className="mr-2" /> Cost: Paid
            </label>
          </div>
          <div className="space-y-2 mt-4">
            <label className="flex items-center">
              <input
                ...
                className="mr-2"
              />
              <FaCalendarAlt className="mr-2" /> Date: All
            </label>
            <label className="flex items-center">
              <input
                type="checkbox"
                ...
                className="mr-2"
              />
              <FaCalendarAlt className="mr-2" /> Date: Past Events
            </label>
            <label className="flex items-center">
              <input
                type="checkbox"
                ...
                className="mr-2"
              />
              <FaCalendarAlt className="mr-2" /> Date: Upcoming Events
            </label>
          </div>
        </DropdownMenuContent>
      </DropdownMenu>
